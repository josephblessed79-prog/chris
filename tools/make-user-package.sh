...
# Finished example documents, so a tester sees real output before typing
# anything. Generated by the same engine the app uses — never hand-made.
node tools/make-samples.js "../$PKG/example-documents" >/dev/null
printf 'HOW TO START\r\n============\r\n1. Open this folder.\r\n2. Double-click the file named  index.html\r\n3. The system opens in your web browser (Edge or Chrome). No internet is needed.\r\n\r\nThe folder  example-documents  holds finished documents produced by this\r\nsystem, so you can see the output before entering anything yourself.\r\n\r\nYour work is saved as small .json case files using the Save Case button.\r\nRead USER-GUIDE.md for a walk-through in plain language.\r\n' > "../$PKG/START-HERE.txt"
